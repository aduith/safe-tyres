...
// Validate ../../app/api/products/custom/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/custom">> = Specific
  const handler = {} as typeof import("../../app/api/products/custom/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
